...
public class GitlabTest {
    private static JSONObject jsonExpected() {
        ...
        expectedSubgroup.put("subgroups", new JSONArray(new JSONObject[] {
                dungeonmania
        }));
        ...
        expected.put("subgroups", new JSONArray(new JSONObject[] {
                expectedSubgroup, blackout
        }));
    ...
    public class RegressionTests {
        ...
        public void testIntegration() {
            ...
            assertThrows(GitlabAuthorisationException.class,
                    () -> group2.updateUserPermissions(user, PermissionsLevel.NONE, user2));
        }
    ...
    public class PartEFactoryTests {
        ...
        public void testFactory() throws IOException {
            ...
            // This is the JSON in the specification
            String input = "{\r\n  \"type\": \"group\",\r\n  \"name\": \"COMP2511\",\r\n  \"subgroups\": [\r\n    {\r\n      \"type\": \"group\",\r\n      \"name\": \"22T2\",\r\n      \"subgroups\": [\r\n        {\r\n          \"type\": \"project\",\r\n          \"name\": \"dungeonmania\"\r\n        }\r\n      ]\r\n    },\r\n    {\r\n      \"type\": \"project\",\r\n      \"name\": \"blackout\"\r\n    }\r\n  ]\r\n}";
